...
class DataArguments:
    train_dataset_path: str = field(
        metadata={"help": "Path to tokenized dataset."}
    )
...
def get_model(args, checkpoint_dir):
...
def train():
    ...
    model = get_model(args, checkpoint_dir)
    ...
    train_ds = datasets.load_from_disk(args.train_dataset_path)
