...
class P3FewshotHyperTrainIterator:
    ...
    def process_multigist(self, ds):
        ...
        attention_mask = compute_gist_attention_mask(all_input_ids, num_gist_tokens=self.num_gist_tokens)
...
def compute_gist_attention_mask(input_ids, num_gist_tokens):
